...
class Application(tk.Frame):
    ...
    # 色の一覧を表示するスクリプト
    def showColorList(self):
        # grid位置を決めるための、カウンタ用変数。
        i = 0
        for colorName in colorList:
            ...
            label = tk.Label(text=colorName, width=15, bg=colorName, foreground='black')
            # 12個のlabel Widgetを横に表示して、次の行へ移動する。繰り返し、12個のlabel Widgetを表示する。
